...
describe('BackupConfiguration', () => {
  ...
  describe('Rendering', () => {
    it('should render the backup configuration title with server name', async () => {
      ...
      await expect.element(page.getByText(`${SERVER_NAME} backup configuration`)).toBeVisible();
    });
    ...
    it('should render SmartScan Configuration section', async () => {
      ...
      await expect.element(page.getByText('SmartScan Configuration')).toBeVisible();
    });
    ...
    it('should render Data Retention Policies section', async () => {
      ...
      await expect.element(page.getByText('Data Retention Policies')).toBeVisible();
    });
  });
  ...
  describe('Service status', () => {
    it('should show "stopped" when backup service is not running', async () => {
      ...
      await expect.element(page.getByText('The service is')).toBeVisible();
    ...
    it('should show "Start service" button when service is stopped', async () => {
      ...
      await expect.element(page.getByRole('button', { name: 'Start service' })).toBeVisible();
    });
    ...
    it('should show "Stop service" button when service is running', async () => {
      ...
      await expect.element(page.getByRole('button', { name: 'Stop service' })).toBeVisible();
    });
  });
  ...
  describe('Switches', () => {
    ...
    it('should render the "Run the Smartscan at startup" switch', async () => {
      ...
      await expect.element(page.getByText('Run the Smartscan at startup')).toBeVisible();
    });
    ...
    it('should not render "Enable RealTime Scanner" when realtime feature is not licensed', async () => {
      ...
      expect(page.getByText('Enable RealTime Scanner').elements()).toHaveLength(0);
    });
  });
  ...
  describe('Initialize Backup', () => {
    it('should render the "Initialize Backup" button', async () => {
      ...
      await expect.element(page.getByRole('button', { name: 'Initialize Backup' })).toBeVisible();
    });
    ...
    it('should disable "Initialize Backup" button when backup is already initialized', async () => {
      ...
      await expect.element(page.getByRole('button', { name: 'Initialize Backup' })).toBeDisabled();
    });
  });
  ...
  describe('SmartScan', () => {
    ...
    it('should render "Force start smartscan now" button', async () => {
      ...
      await expect
        .element(page.getByRole('button', { name: 'Force start smartscan now' }))
        .toBeVisible();
    });
  ...
  describe('Data Retention', () => {
    it('should render "Schedule automatic retention policies" switch', async () => {
      ...
      await expect.element(page.getByText('Schedule automatic retention policies')).toBeVisible();
    });
    ...
    it('should render "Force backup purge now" button', async () => {
      ...
      await expect
        .element(page.getByRole('button', { name: 'Force backup purge now' }))
        .toBeVisible();
    });
  ...
  describe('External Volume', () => {
    ...
    it('should disable "Set external volume" when backup is not initialized', async () => {
      ...
      await expect
        .element(page.getByRole('button', { name: 'Set external volume' }))
        .toBeDisabled();
    });
