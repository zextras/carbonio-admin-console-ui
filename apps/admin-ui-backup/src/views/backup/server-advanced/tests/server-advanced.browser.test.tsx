...
describe('ServerAdvanced', () => {
    ...
    describe('Rendering', () => {
        ...
        it('should render the "Check ldap" button', async () => {
            ...
            await expect
                .element(page.getByRole('button', { name: 'Check ldap' }))
                .toBeVisible();
        });
    ...
    describe('Switches', () => {
        ...
        it('should render Include server configuration switch', async () => {
            ...
            await expect
                .element(page.getByText('Include server configuration'))
                .toBeVisible();
        });
        ...
        it('should render Purge old configuration switch', async () => {
            ...
            await expect
                .element(page.getByText('Purge old configuration'))
                .toBeVisible();
        });
        ...
        it('should render metadata switches', async () => {
            ...
            await expect
                .element(
                    page.getByText('Append metadata instead of rewrite (faster but dangerous)'),
                )
                .toBeVisible();
            await expect
                .element(
    ...
    describe('Input fields', () => {
        it('should render latency inputs', async () => {
            ...
            await expect
                .element(page.getByText('Latency High Threshold (ms)'))
                .toBeVisible();
            await expect
                .element(page.getByText('Latency Low Threshold (ms)'))
                .toBeVisible();
        });
        ...
        it('should render Max Waiting Time input', async () => {
            ...
            await expect
                .element(page.getByText('Max Waiting Time (ms)'))
                .toBeVisible();
        });
        ...
        it('should render Maximum Metadata Size input', async () => {
            ...
            await expect
                .element(page.getByText('Maximum Metadata Size (MB)'))
                .toBeVisible();
        });
        ...
        it('should render Other Controls inputs', async () => {
            ...
            await expect
                .element(page.getByText('Maximum Operation per Account'))
                .toBeVisible();
            await expect
                .element(page.getByText('Compression Level'))
                .toBeVisible();
            await expect
                .element(page.getByText('Thread number for items'))
                .toBeVisible();
            await expect
                .element(page.getByText('Thread number for accounts'))
                .toBeVisible();
        });
    });
