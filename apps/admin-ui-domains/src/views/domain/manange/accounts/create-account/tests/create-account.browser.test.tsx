...
describe('CreateAccountDetailSection (browser)', () => {
    ...
    describe('Basic Rendering', () => {
        ...
        it('should render all required account input fields', async () => {
            ...
            await expect.element(page.getByLabelText('Domain Name')).toBeVisible();
        ...
        it('should display domain name as read-only', async () => {
            ...
            const domainField = page.getByLabelText('Domain Name');
            await expect.element(domainField).toBeVisible();
            await expect.element(domainField).toHaveValue('test-domain.com ');
            await expect.element(domainField).toBeDisabled();
        });
    });
