...
describe('DomainGeneralSettings (browser)', () => {
	...
	describe('Rendering', () => {
		...
		it('should render the domain name input', async () => {
			...
			const nameInput = page.getByTestId('input-domain-name');
		...
		it('should render the domain ID input', async () => {
			...
			const idInput = page.getByTestId('input-domain-id');
		...
		it('should render the Domain System Notifications section', async () => {
			...
			await expect
				.element(page.getByText('Domain System Notifications'))
				.toBeVisible();
		});
		...
		it('should render the Notification Sender input with pre-filled value', async () => {
			...
			await expect
				.element(page.getByText('Notification Sender'))
				.toBeVisible();
		});
		...
		it('should render the Delete Domain button', async () => {
			...
			await expect
				.element(page.getByRole('button', { name: /delete domain/i }))
				.toBeVisible();
		});
				...
				domain: [
					{
						...
						a: buildDomainAttributes([
							{ n: 'description', _content: 'New description' },
						]),
					},
				],
			});
	...
	describe('Notification Recipients', () => {
		it('should render the Send notifications to chip input', async () => {
			...
			await expect
				.element(page.getByText('Send notifications to...'))
				.toBeVisible();
		});
	});
