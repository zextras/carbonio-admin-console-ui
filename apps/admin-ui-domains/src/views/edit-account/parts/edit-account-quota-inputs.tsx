...
import { computedLimitToLimit, quotaExceedsDomainLimit, quotaValueFromLimit } from './quota-utils';
import { TotalQuotaSourceIcon } from './total-quota-source-icon';

type QuotaLimitInputProps = {
...
export const QuotaLimitInput = ({
  ...
  totalQuotaSource,
  onChange,
}: QuotaLimitInputProps): React.JSX.Element | null => {
