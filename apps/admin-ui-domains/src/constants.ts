...
export const APP_ID = 'carbonio-admin-ui-domains';
...
export const ADDRESS_BOOK_SERVICE_ENABLED = 'addressBookServiceEnabled';
export const ZX_CONFIG_GLOBAL_ACTION = 'global';
