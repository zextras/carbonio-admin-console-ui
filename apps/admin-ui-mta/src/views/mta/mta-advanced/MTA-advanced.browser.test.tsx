...
async function expectMailMessagesSizeSectionVisible() {
  await expect.element(page.getByText('Mail messages size', { exact: true })).toBeVisible();
...
describe('MTAAdvanced', () => {
  ...
  it('should render the component correctly', async () => {
    ...
    await expectMailMessagesSizeSectionVisible();
  });
  ...
  it('should handle mail message size radio button interactions', async () => {
    ...
    await expect.element(customSizeRadio).toBeVisible();
  ...
  it('should handle switch interactions', async () => {
    ...
    await expect.element(authSwitchLabel).toBeVisible();
  ...
  it('should handle component initialization with no message size limit', async () => {
    ...
    const noLimitRadio = page.getByRole('radio', { name: 'No size limit for mail messages' });
    await expect.element(noLimitRadio).toBeChecked();
