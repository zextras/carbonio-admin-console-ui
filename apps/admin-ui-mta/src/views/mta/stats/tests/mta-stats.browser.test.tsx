...
describe('MTAStats', () => {
    ...
    it('renders the page title', async () => {
        ...
        await setupBrowserTest(<MTAStats />);
    ...
    it('renders the Restart Scan and Flush queues buttons', async () => {
        ...
        await expect
            .element(page.getByRole('button', { name: 'Restart Scan' }))
            .toBeVisible();
        await expect
            .element(page.getByRole('button', { name: 'Flush queues' }))
            .toBeVisible();
    });
    ...
    it('renders the helper text for selecting a server', async () => {
        ...
        await expect
            .element(page.getByText('Select a mail server to see its stats'))
            .toBeVisible();
    });
