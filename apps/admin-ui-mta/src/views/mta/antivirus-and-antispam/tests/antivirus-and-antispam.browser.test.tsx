...
async function expectAntispamSectionVisible() {
  ...
  await expect.element(page.getByText('Add this prefix to the Spam mail subject')).toBeVisible();
...
async function expectAntivirusDefinitionsSectionVisible() {
  await expect.element(page.getByText('Antivirus Definitions', { exact: true })).toBeVisible();
  ...
  await expect.element(page.getByText('Definition Update Frenquency')).toBeVisible();
}
...
async function expectAntivirusWarningsSwitchesVisible() {
  await expect
    ...
    .toBeVisible();
  await expect.element(page.getByText('Virus Block Encrypted Archive')).toBeVisible();
