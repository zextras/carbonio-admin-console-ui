...
async function expectAuthenticationInputsVisible() {
    await expect
        .element(page.getByText('Relay Host', { exact: true }))
        .toBeVisible();
...
async function expectAntispamAntivirusSectionVisible() {
    await expect
        .element(page.getByText('Antispam & Antivirus', { exact: true }))
        .toBeVisible();
...
async function expectLoggingSectionVisible() {
    ...
    await expect
        .element(page.getByText('Log level for Amavis', { exact: true }))
        .toBeVisible();
