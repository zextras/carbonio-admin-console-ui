...
async function expectDnsBlacklistingSectionVisible() {
  ...
  await expect.element(page.getByText('DNS Blacklist Whitelist Threshold  (value)')).toBeVisible();
  await expect.element(page.getByText('DNS Blacklist Min Time to Live (value)')).toBeVisible();
  await expect.element(page.getByText('DNS Blacklist Max Time to Live (value)')).toBeVisible();
  await expect.element(page.getByText('DNS Blacklist Time to Live (value)')).toBeVisible();
}
