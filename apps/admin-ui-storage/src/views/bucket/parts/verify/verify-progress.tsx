    ...
    <div popover="manual" ref={popoverRef} className={styles.popover}>
      ...
      <ul className={styles.stepList}>
        <li className={styles.stepItem}>
          ...
          <ds-text as="span">
            {t('storages.s3Connectors.verifyProgress.validatingSSL', 'Validating SSL certificates')}
          </ds-text>
        </li>
        <li className={styles.stepItem}>
          <div className={styles.stepSpinner} />
          <ds-text as="span">
            {t('storages.s3Connectors.verifyProgress.validatingRegion', 'Validating Region')}
          </ds-text>
        </li>
        <li className={styles.stepItem}>
          <div className={styles.stepSpinner} />
          <ds-text as="span">
            {t('storages.s3Connectors.verifyProgress.validatingAccessKey', 'Validating access key')}
          </ds-text>
        </li>
      </ul>
