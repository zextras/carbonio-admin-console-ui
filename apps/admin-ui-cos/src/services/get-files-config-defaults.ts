...
/**
 * Returns the base defaults for every declared key (read-only, complete). This is the
 * inherited fallback (source `default`) shown on the cos scope when nothing is set there.
