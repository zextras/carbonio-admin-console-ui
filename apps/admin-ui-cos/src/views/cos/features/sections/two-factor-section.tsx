...
export const TwoFactorSection = withForm({
  defaultValues: {} as CosFeaturesFormValues,
  props: { readonlyCOS: false as boolean, isAdvanced: false as boolean },
  render: function Render({ form, readonlyCOS, isAdvanced }) {
      ...
      >
        ...
        >
          ...
          <Row width="100%" mainAlignment="flex-start" padding={{ top: 'large' }}>
            <form.AppField name="carbonioFeatureOTPMgmtEnabled">
              {(field) => (
