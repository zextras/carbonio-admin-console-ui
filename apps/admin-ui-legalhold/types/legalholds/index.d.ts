...
export type LegalHoldOperationResponse = {
  accounts?: Array<BackupAccountItem>;
  [serverName: string]: ServerBackupResponse | Array<BackupAccountItem> | undefined;
};
...
export type ServiceSuccess<T> = { type: 'success' } & T;
export type ServiceError = { type: 'error'; error: string };
