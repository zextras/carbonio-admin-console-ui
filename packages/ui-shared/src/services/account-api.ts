...
export const fetchAccountInfo = async (): Promise<Account> => {
  const response = await directSoapFetch<
    { _jsns: string; rights: string },
    GetInfoResponse
  >("GetInfo", {
    _jsns: "urn:zimbraAccount",
    rights:
      "sendAs,sendAsDistList,viewFreeBusy,sendOnBehalfOf,sendOnBehalfOfDistList",
  });
