...
const STORAGES_API_BASE_URL = '/services/storages/admin';
const STORAGES_API_VERSION = '2';
const STORAGES_API_VERSION_HEADER = 'X-API-Version';
...
export type GetCosQuotaResponse =
	| {
			type: 'success';
