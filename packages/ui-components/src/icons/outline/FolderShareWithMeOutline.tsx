...
const SvgFolderShareWithMeOutline = (props: SVGProps<SVGSVGElement>): React.JSX.Element => (
	<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" {...props}>
		<path d="M8.535 13.439q.074-.181.21-.32l2.016-2.016a1 1 0 0 1 1.42 0 1 1 0 0 1 0 1.42l-.316.306H14.5c.549 0 1 .451 1 1s-.451 1-1 1h-2.705l.4.48a1.001 1.001 0 0 1-1.45 1.38l-2.03-2.17a1 1 0 0 1-.09-.13.818.818 0 0 1-.17-.46v-.1a1 1 0 0 1 .08-.39" />
		<path
			fillRule="evenodd"
