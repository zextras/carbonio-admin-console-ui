...
export const NOTIFICATION_TABLE_DATABASE = 'notification_tb_db';
export const STORAGES_DATABASE = 'storages_db';
export const STORAGES_TABLE_DATABASE = 'storages_tb_db';
